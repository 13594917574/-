  ...
  <div class="loagin">
    <div class="header">
      ...
      <div class="tabs">
        <ul>
          <li  class="login_a">
            <a href="#login_form" @click="showI(1)">普通登录</a>
            <i v-show="isShowI1"></i>
          </li>
          <li class="login_a">
            <a href="#newlogin_form" @click="showI(2)">手机动态密码登录</a>
            <i  v-show="isShowI2"></i>
          </li>
        </ul>
      </div>
    ...
    <div class="main">
      <div class="mformBox">
        <div id="login_form" v-show="isShowI1" >
          <ul>
            <li class="clearfix">
        ...
        <div id="newlogin_form" v-show="isShowI2">
          <ul>
            <li class="clearfix">
...
<script>
  export default{
    ...
    methods:{
      showI(click){
        if(click===1 && this.isShowI1==true){
            return
        }else if(click===2 && this.isShowI2==true){
            return
        }else{
